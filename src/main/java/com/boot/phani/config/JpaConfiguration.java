...
@Configuration
@EnableJpaRepositories(basePackages = "com.boot.phani.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.boot.phani.domain" });
	...
	private Properties jpaProperties() {
		...
		if(StringUtils.isEmpty(environment.getRequiredProperty("datasource.atsea.defaultSchema"))){
